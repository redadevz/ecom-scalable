    ...
    <PageContent>
        ...
        >
            ...
            <template #tableRow="{ item, action }: any">
                <ListingDataCell>
                    <span class="text-sm text-gray-500">{{ item.exit_stock_time && dayjs(item.exit_stock_time).format('DD MMM YYYY') }}</span>
                </ListingDataCell>
                <ListingDataCell>
                ...
                <ListingDataCell>
                    <div class="flex items-center justify-end gap-3">
                        <IconButton
                            :as="Link"
                            :href="route('craftable-pro.loss-and-damages.edit', item)"
                            variant="ghost"
                            color="gray"
                        ...
                        <Modal type="danger">
                            ...
                            <template #buttons="{ setIsOpen }">
                                <Button
                                    @click.prevent="
                                        () => {
                                            action('delete', route('craftable-pro.loss-and-damages.destroy', item), {
                                                onFinish: () => setIsOpen(false),
                                            });
                                        }
                                    "
