            ...
            <div class="space-y-6 lg:col-span-2">
                ...
                <section :class="cardCls">
                    <header :class="headerCls">
                        <span :class="iconBadge"><DocumentMinusIcon class="h-5 w-5" /></span>
                        <div>
                            <h3 :class="titleCls">Write-off</h3>
                            <p :class="subCls">Describe the loss or damage and when the stock left inventory.</p>
                        </div>
                    </header>
...
import type { LossAndDamageForm } from "./types";

interface Props {
    form: InertiaForm<LossAndDamageForm>;
    submit: void;
}
