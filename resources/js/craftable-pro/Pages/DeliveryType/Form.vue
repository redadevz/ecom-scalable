                ...
                <section :class="cardCls">
                    <header :class="headerCls">
                        ...
                        <div>
                            ...
                            <p :class="subCls">Name and description of this delivery type.</p>
                        </div>
                    </header>
                ...
                <div class="lg:sticky lg:top-24 space-y-6">
                    ...
                    <section :class="cardCls">
                        ...
                        <div class="divide-y divide-gray-100 dark:divide-[#2a2d38]">
                            <ToggleRow v-model="form.is_active" title="Active" desc="Inactive delivery types are hidden from operations." />
                        </div>
                    </section>
                </div>
            </div>
...
import type { DeliveryTypeForm } from "./types";

interface Props {
    form: InertiaForm<DeliveryTypeForm>;
    submit: void;
}
