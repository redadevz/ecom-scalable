<template>
    ...
    <PageContent>
        ...
        >
            ...
            <template #tableHead>
                <ListingHeaderCell sortBy='description'>Discount</ListingHeaderCell>
                <ListingHeaderCell sortBy='discount_type_id'>Type</ListingHeaderCell>
                <ListingHeaderCell>Applies to</ListingHeaderCell>
