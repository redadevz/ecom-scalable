    ...
    <PageContent>
        ...
        >
            ...
            <template #tableRow="{ item, action }: any">
                <ListingDataCell>
                    <span class="font-medium text-gray-900 dark:text-white">{{ item.supplier_price_before_tax }}</span>
                </ListingDataCell>
                <ListingDataCell>
                ...
                <ListingDataCell>
                    <div class="flex items-center justify-end gap-3">
                        <IconButton
                            :as="Link"
                            :href="route('craftable-pro.purchase-items.edit', item)"
                            variant="ghost"
                            color="gray"
                        ...
                        <Modal type="danger">
                            ...
                            <template #buttons="{ setIsOpen }">
                                <Button
                                    @click.prevent="
                                        () => {
                                            action('delete', route('craftable-pro.purchase-items.destroy', item), {
                                                onFinish: () => setIsOpen(false),
                                            });
                                        }
                                    "
