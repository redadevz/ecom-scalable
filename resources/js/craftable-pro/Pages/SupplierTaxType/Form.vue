            ...
            <div class="space-y-6 lg:col-span-2">
                ...
                <section :class="cardCls">
                    <header :class="headerCls">
                        ...
                        <div>
                            ...
                            <p :class="subCls">Name, code and the rate applied.</p>
                        </div>
                    </header>
                ...
                <section :class="cardCls">
                    <header :class="headerCls">
                        ...
                        <div>
                            <h3 :class="titleCls">Validity</h3>
                            <p :class="subCls">When this tax type is effective.</p>
                        </div>
                    </header>
                    <div class="grid grid-cols-1 gap-x-6 gap-y-5 p-6 sm:grid-cols-2">
                ...
                <section :class="cardCls">
                    <header :class="headerCls">
                        ...
                        <div>
                            ...
                            <p :class="subCls">Internal comments about this tax type.</p>
                        </div>
                    </header>
                    <div class="p-6">
                ...
                <div class="lg:sticky lg:top-24 space-y-6">
                    ...
                    <section :class="cardCls">
                        ...
                        <div class="divide-y divide-gray-100 dark:divide-[#2a2d38]">
                            <ToggleRow v-model="form.is_active" title="Active" desc="Inactive tax types are hidden from operations." />
                            <ToggleRow v-model="form.is_percentage" title="Percentage" desc="Value is a percentage rather than a flat amount." />
                        </div>
                    </section>
...
import type { SupplierTaxTypeForm } from "./types";

interface Props {
    form: InertiaForm<SupplierTaxTypeForm>;
    submit: void;
}
