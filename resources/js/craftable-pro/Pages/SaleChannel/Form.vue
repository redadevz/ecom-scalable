                ...
                <section :class="cardCls">
                    <header :class="headerCls">
                        ...
                        <div>
                            ...
                            <p :class="subCls">Name and description of the sale channel.</p>
                        </div>
                    </header>
                ...
                <div class="lg:sticky lg:top-24 space-y-6">
                    ...
                    <section class="relative overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-[#2c2f3d] dark:bg-[#1e2029]">
                        ...
                        <div class="px-5 pb-5">
                            ...
                            <p v-if="form.description" class="mt-3 border-t border-gray-100 pt-3 text-sm text-gray-600 dark:border-[#2a2d38] dark:text-gray-300">{{ form.description }}</p>
                            <p v-else class="mt-3 border-t border-gray-100 pt-3 text-xs text-gray-400 dark:border-[#2a2d38]">The description appears here as you fill it in.</p>
                        </div>
                    </section>
                    ...
                    <section :class="cardCls">
                        ...
                        <div class="divide-y divide-gray-100 dark:divide-[#2a2d38]">
                            <ToggleRow v-model="form.is_active" title="Active" desc="Inactive sale channels are hidden from operations." />
                        </div>
                    </section>
                </div>
            </div>
...
import type { SaleChannelForm } from "./types";

interface Props {
    form: InertiaForm<SaleChannelForm>;
    submit: void;
}
...
const displayName = computed(() => props.form.name || "New Sale Channel");
