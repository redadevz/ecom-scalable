<template>
    ...
    <PageContent>
        ...
        >
            ...
            <template #tableHead>
                <ListingHeaderCell sortBy='discount_type_id'>Discount</ListingHeaderCell>
                <ListingHeaderCell sortBy='start_time'>Schedule window</ListingHeaderCell>
                <ListingHeaderCell sortBy='comments'>Comments</ListingHeaderCell>
                <ListingHeaderCell sortBy='day_of_week'>Status</ListingHeaderCell>
