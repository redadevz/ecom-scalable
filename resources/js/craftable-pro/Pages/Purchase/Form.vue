            ...
            <div class="space-y-6 lg:col-span-2">
                ...
                <section :class="cardCls">
                    <header :class="headerCls">
                        ...
                        <div>
                            <h3 :class="titleCls">Purchase</h3>
                            <p :class="subCls">When the stock was entered into the system.</p>
                        </div>
                    </header>
                ...
                <section :class="cardCls">
                    <header :class="headerCls">
                        ...
                        <div>
                            ...
                            <p :class="subCls">Description and internal comments for this purchase.</p>
                        </div>
                    </header>
                    <div class="grid grid-cols-1 gap-x-6 gap-y-5 p-6 sm:grid-cols-2">
                ...
                <div class="lg:sticky lg:top-24 space-y-6">
                    ...
                    <section :class="cardCls">
                        ...
                        <div class="divide-y divide-gray-100 dark:divide-[#2a2d38]">
                            <ToggleRow v-model="form.is_paid" title="Is Paid" desc="Mark this purchase as paid." />
                        </div>
                    </section>
