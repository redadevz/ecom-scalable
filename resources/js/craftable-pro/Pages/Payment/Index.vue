        ...
        >
            ...
            <template #tableHead>
                ...
                <ListingHeaderCell sortBy='provider'>
                    {{ $t("craftable-pro", "Provider") }}
                </ListingHeaderCell>
                <ListingHeaderCell sortBy='provider_reference'>
                    {{ $t("craftable-pro", "Provider Reference") }}
                </ListingHeaderCell>
...
const downloadFile = () => {
    ...
    if(url.length > 1) {
        window.location = route('craftable-pro.payments.export', url.pop()).slice(0, -1);
    } else {
        window.location = route('craftable-pro.payments.export');
    }
}
</script>
