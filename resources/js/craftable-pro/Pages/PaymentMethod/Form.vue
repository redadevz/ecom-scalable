                ...
                <section :class="cardCls">
                    <header :class="headerCls">
                        ...
                        <div>
                            ...
                            <p :class="subCls">Name, code and how this payment method is presented.</p>
                        </div>
                    </header>
                    <div class="grid grid-cols-1 gap-x-6 gap-y-5 p-6 sm:grid-cols-2">
                        ...
                        <TextInput v-model="form.sequence_no" name="sequence_no" label="Sequence No" type="number" />
                ...
                <div class="lg:sticky lg:top-24 space-y-6">
                    ...
                    <section :class="cardCls">
                        ...
                        <div class="divide-y divide-gray-100 dark:divide-[#2a2d38]">
                            <ToggleRow v-model="form.is_active" title="Active" desc="Inactive payment methods are hidden at checkout." />
                            <ToggleRow v-model="form.is_customer_required" title="Customer required" desc="Requires a customer to be selected to use this method." />
                        </div>
                    </section>
                </div>
            </div>
...
interface Props {
    form: InertiaForm<PaymentMethodForm>;
    submit: void;
}
defineProps<Props>();
