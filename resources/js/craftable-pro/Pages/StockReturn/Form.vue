                ...
                <section :class="cardCls">
                    <header :class="headerCls">
                        ...
                        <div>
                            ...
                            <p :class="subCls">What is being returned and when it leaves stock.</p>
                        </div>
                    </header>
                    <div class="grid grid-cols-1 gap-x-6 gap-y-5 p-6 sm:grid-cols-2">
                        <DatePicker
                            v-model="form.exit_stock_time"
                            name="exit_stock_time"
                            mode="dateTime"
                            label="Exit Stock Time"
                        />
                ...
                <section :class="cardCls">
                    <header :class="headerCls">
                        ...
                        <div>
                            ...
                            <p :class="subCls">Internal notes about this return.</p>
                        </div>
                    </header>
                    <div class="p-6">
                        <TextInput
                ...
                <div class="lg:sticky lg:top-24 space-y-6">
                    ...
                    <section :class="cardCls">
                        ...
                        <div class="divide-y divide-gray-100 dark:divide-[#2a2d38]">
                            <ToggleRow v-model="form.is_paid" title="Paid" desc="Mark this return as settled." />
                        </div>
                    </section>
...
import type { StockReturnForm } from "./types";

interface Props {
    form: InertiaForm<StockReturnForm>;
    submit: void;
}
