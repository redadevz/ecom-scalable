<template>
    <PageHeader :title="$t('craftable-pro', 'Order Discounts')">
        <Button
            :leftIcon="PlusIcon"
            :as="Link"
            :href="route('craftable-pro.order-discounts.create')"
            v-can="'craftable-pro.order-discounts.create'"
        >
    ...
    <PageContent>
        <Listing
            :baseUrl="route('craftable-pro.order-discounts.index')"
            :data="orderDiscounts"
            dataKey="orderDiscounts"
        >
                ...
                <Modal type="danger">
                    ...
                    <template #buttons="{ setIsOpen }">
                        <Button
                            @click.prevent="
                                () => {
                                    bulkAction('post', route('craftable-pro.order-discounts.bulk-destroy'), {
            ...
            <template #tableHead>
                <ListingHeaderCell sortBy='discount_id'>Discount</ListingHeaderCell>
                <ListingHeaderCell sortBy='order_id'>Order</ListingHeaderCell>
                <ListingHeaderCell sortBy='value'>Value</ListingHeaderCell>
