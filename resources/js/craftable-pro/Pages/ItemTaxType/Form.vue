                ...
                <section :class="cardCls">
                    <header :class="headerCls">
                        ...
                        <div>
                            ...
                            <p :class="subCls">Validity window and notes for this item tax type.</p>
                        </div>
                    </header>
...
import type { ItemTaxTypeForm } from "./types";

interface Props {
    form: InertiaForm<ItemTaxTypeForm>;
    submit: void;
}
