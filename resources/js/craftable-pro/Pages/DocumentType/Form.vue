                ...
                <section :class="cardCls">
                    <header :class="headerCls">
                        ...
                        <div>
                            ...
                            <p :class="subCls">Name and descriptive information for this document type.</p>
                        </div>
                    </header>
                ...
                <div class="lg:sticky lg:top-24 space-y-6">
                    ...
                    <section :class="cardCls">
                        ...
                        <div class="divide-y divide-gray-100 dark:divide-[#2a2d38]">
                            <ToggleRow v-model="form.is_active" title="Active" desc="Inactive document types are hidden from operations." />
                        </div>
                    </section>
                    ...
                    <section :class="cardCls">
                        ...
                        <div class="space-y-4 p-5">
                            <Multiselect v-model="form.document_category_id" name="document_category_id" label="Document Category" mode="single"
                                :options="$page.props.document_categories ?? []" options-value-prop="id" options-label="name" :searchable="true" />
                        </div>
                    </section>
                </div>
            </div>
...
import type { DocumentTypeForm } from "./types";

interface Props {
    form: InertiaForm<DocumentTypeForm>;
    submit: void;
}
defineProps<Props>();
