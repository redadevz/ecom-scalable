                ...
                <section :class="cardCls">
                    <header :class="headerCls">
                        ...
                        <div>
                            ...
                            <p :class="subCls">The country's display name.</p>
                        </div>
                    </header>
                ...
                <div class="lg:sticky lg:top-24 space-y-6">
                    ...
                    <section class="relative overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-[#2c2f3d] dark:bg-[#1e2029]">
                        ...
                        <div class="px-5 pb-5">
                            ...
                            <p class="mt-1 text-xs text-gray-400">The name appears here as you type.</p>
                        </div>
                    </section>
                </div>
            </div>
...
import type { CountryForm } from "./types";

interface Props {
    form: InertiaForm<CountryForm>;
    submit: void;
}
...
const displayName = computed(() => props.form.name?.toString().trim() || "New Country");
