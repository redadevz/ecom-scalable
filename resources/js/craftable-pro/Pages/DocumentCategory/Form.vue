            ...
            <div class="space-y-6 lg:col-span-2">
                ...
                <section :class="cardCls">
                    <header :class="headerCls">
                        <span :class="iconBadge"><FolderIcon class="h-5 w-5" /></span>
                        <div>
                            <h3 :class="titleCls">Details</h3>
                            <p :class="subCls">Name this category and describe what it is for.</p>
                        </div>
                    </header>
                ...
                <div class="lg:sticky lg:top-24 space-y-6">
                    ...
                    <section :class="cardCls">
                        ...
                        <div class="divide-y divide-gray-100 dark:divide-[#2a2d38]">
                            <ToggleRow v-model="form.is_active" title="Active" desc="Inactive categories are hidden from operations." />
                        </div>
                    </section>
                </div>
            </div>
...
import type { DocumentCategoryForm } from "./types";

interface Props {
    form: InertiaForm<DocumentCategoryForm>;
    submit: void;
}
defineProps<Props>();
