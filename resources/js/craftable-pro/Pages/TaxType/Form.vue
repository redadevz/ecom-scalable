            ...
            <div class="space-y-6 lg:col-span-2">
                ...
                <section :class="cardCls">
                    <header :class="headerCls">
                        ...
                        <div>
                            <h3 :class="titleCls">Tax</h3>
                            <p :class="subCls">Name, code and the rate applied by this tax type.</p>
                        </div>
                    </header>
                ...
                <section :class="cardCls">
                    <header :class="headerCls">
                        ...
                        <div>
                            ...
                            <p :class="subCls">Optional period during which this tax type applies.</p>
                        </div>
                    </header>
                    <div class="grid grid-cols-1 gap-x-6 gap-y-5 p-6 sm:grid-cols-2">
                ...
                <div class="lg:sticky lg:top-24 space-y-6">
                    ...
                    <section :class="cardCls">
                        ...
                        <div class="divide-y divide-gray-100 dark:divide-[#2a2d38]">
                            ...
                            <ToggleRow v-model="form.is_percentage" title="Percentage" desc="Treat the value as a percentage rate." />
                        </div>
                    </section>
