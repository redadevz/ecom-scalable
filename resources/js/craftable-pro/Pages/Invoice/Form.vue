            ...
            <div class="space-y-6 lg:col-span-2">
                ...
                <section :class="cardCls">
                    <header :class="headerCls">
                        ...
                        <div>
                            <h3 :class="titleCls">Invoice</h3>
                            <p :class="subCls">Invoice number and payment schedule.</p>
                        </div>
                    </header>
                ...
                <section :class="cardCls">
                    <header :class="headerCls">
                        ...
                        <div>
                            ...
                            <p :class="subCls">Internal comments about this invoice.</p>
                        </div>
                    </header>
                    <div class="p-6">
                        <TextInput
                ...
                <div class="lg:sticky lg:top-24 space-y-6">
                    ...
                    <section :class="cardCls">
                        ...
                        <div class="divide-y divide-gray-100 dark:divide-[#2a2d38]">
                            <ToggleRow v-model="form.is_paid" title="Is Paid" desc="Mark this invoice as paid." />
                        </div>
                    </section>
