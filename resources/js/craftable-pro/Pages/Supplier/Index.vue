<template>
    ...
    <PageContent>
        ...
        >
            ...
            <template #tableHead>
                <ListingHeaderCell sortBy='first_name'>Supplier</ListingHeaderCell>
                <ListingHeaderCell sortBy='is_company'>Type</ListingHeaderCell>
                <ListingHeaderCell sortBy='phone'>Contact</ListingHeaderCell>
