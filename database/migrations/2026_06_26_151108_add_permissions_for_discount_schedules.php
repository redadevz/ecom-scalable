...
return new class extends Migration
{
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            "craftable-pro.discount-schedules.index",
            "craftable-pro.discount-schedules.create",
            "craftable-pro.discount-schedules.edit",
            "craftable-pro.discount-schedules.destroy"
        ]);
