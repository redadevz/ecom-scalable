...
return new class extends Migration
{
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            "craftable-pro.supplier-tax-types.index",
            "craftable-pro.supplier-tax-types.create",
            "craftable-pro.supplier-tax-types.edit",
            "craftable-pro.supplier-tax-types.destroy"
        ]);
