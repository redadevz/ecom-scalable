...
return new class extends Migration
{
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            "craftable-pro.supplier-item-tax-types.index",
            "craftable-pro.supplier-item-tax-types.create",
            "craftable-pro.supplier-item-tax-types.edit",
            "craftable-pro.supplier-item-tax-types.destroy"
        ]);
