...
return new class extends Migration
{
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            "craftable-pro.document-categories.index",
            "craftable-pro.document-categories.create",
            "craftable-pro.document-categories.edit",
            "craftable-pro.document-categories.destroy"
        ]);
