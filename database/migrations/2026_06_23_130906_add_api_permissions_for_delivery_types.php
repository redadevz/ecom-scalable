...
return new class extends Migration
{
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            "craftable-pro-api.delivery-types.index",
            "craftable-pro-api.delivery-types.store",
            "craftable-pro-api.delivery-types.update",
            "craftable-pro-api.delivery-types.show",
            "craftable-pro-api.delivery-types.destroy"
        ]);
