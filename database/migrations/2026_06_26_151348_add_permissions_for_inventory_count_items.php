...
return new class extends Migration
{
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            "craftable-pro.inventory-count-items.index",
            "craftable-pro.inventory-count-items.create",
            "craftable-pro.inventory-count-items.edit",
            "craftable-pro.inventory-count-items.destroy"
        ]);
