...
return new class extends Migration
{
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            "craftable-pro.sale-return-items.index",
            "craftable-pro.sale-return-items.create",
            "craftable-pro.sale-return-items.edit",
            "craftable-pro.sale-return-items.destroy"
        ]);
