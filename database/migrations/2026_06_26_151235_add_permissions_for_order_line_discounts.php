...
return new class extends Migration
{
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            "craftable-pro.order-line-discounts.index",
            "craftable-pro.order-line-discounts.create",
            "craftable-pro.order-line-discounts.edit",
            "craftable-pro.order-line-discounts.destroy"
        ]);
