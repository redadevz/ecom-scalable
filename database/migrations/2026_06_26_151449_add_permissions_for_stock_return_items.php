...
return new class extends Migration
{
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            "craftable-pro.stock-return-items.index",
            "craftable-pro.stock-return-items.create",
            "craftable-pro.stock-return-items.edit",
            "craftable-pro.stock-return-items.destroy"
        ]);
