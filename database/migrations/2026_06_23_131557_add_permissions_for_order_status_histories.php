...
return new class extends Migration
{
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            "craftable-pro.order-status-histories.index",
            "craftable-pro.order-status-histories.create",
            "craftable-pro.order-status-histories.edit",
            "craftable-pro.order-status-histories.destroy"
        ]);
