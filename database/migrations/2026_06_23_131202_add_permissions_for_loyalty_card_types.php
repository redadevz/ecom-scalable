...
return new class extends Migration
{
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            "craftable-pro.loyalty-card-types.index",
            "craftable-pro.loyalty-card-types.create",
            "craftable-pro.loyalty-card-types.edit",
            "craftable-pro.loyalty-card-types.destroy"
        ]);
