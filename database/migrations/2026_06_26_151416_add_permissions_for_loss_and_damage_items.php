...
return new class extends Migration
{
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            "craftable-pro.loss-and-damage-items.index",
            "craftable-pro.loss-and-damage-items.create",
            "craftable-pro.loss-and-damage-items.edit",
            "craftable-pro.loss-and-damage-items.destroy"
        ]);
