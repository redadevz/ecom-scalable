...
use App\Exports\CraftablePro\PaymentExport;
...
use App\Http\Requests\CraftablePro\Payment\ExportPaymentRequest;
...
class PaymentController extends Controller
{
    ...
    */
     ...
     * Export
     */
    public function export(ExportPaymentRequest $request): BinaryFileResponse
    {
        return Excel::download(new PaymentExport($request->all()), 'payments-'.now()->format("dmYHi").'.xlsx');
    }
}
